...
namespace Communication
{
    public abstract class SerialCommunication
    {
        ...
        public abstract void SendControlSettings(int mixing, double max_pitch, double max_roll, int aileron_differential, double waypoint_radius, double cruising_speed, bool stabilization_with_altitude_hold);
