...
namespace GluonCS.Markers
{
    public class AbsoluteMarker : NavigationMarker
    {
        ...
        public AbsoluteMarker(PointLatLng p, int wp_number, bool out_of_sync = false)
            : base(p, wp_number)
        {
        ...
        public override void OnRender(Graphics g)
        {
            ...
            g.FillRectangle(Brushes.White, new Rectangle(LocalPosition.X, LocalPosition.Y, Size.Width, Size.Height));
